...
import socialMedia from '../../assets/Group 1000001745.svg'
import bottomLogo from '../../assets/Group 1000001703.svg'
            ...
            <div className="footer__top">
                <div className="footer__logo-section">
                    ...
                    <div className="footer__social">
                        <img className="footer__icon" src={socialMedia} alt='social' />
                        <img className="footer__icon" src={bottomLogo} alt='ic-market' />
                    </div>
                </div>
